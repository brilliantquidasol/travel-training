...
export const referenceAssets = {
  ...
  howItWorks: [
    { image: `${BASE}/nEBCuH9FlYd657RbZ8sdM5u77IDpi8jqr1yHXTzo.png`, title: 'Get Travel Insurence', subtitle: 'We provide a range of digital marketing solutions including website design.' },
    { image: `${BASE}/mwaElp4ajRY3FRJMJGVsu6HFt9fvlFSXcUNhO1BN.png`, title: 'Compare & Book', subtitle: 'We provide a range of digital marketing solutions including website design.' },
    { image: `${BASE}/mpU3w8gTsT8BdBgmj4jJgRXPniBmQGQxxfKsMIFg.png`, title: 'Book a Room', subtitle: 'We provide a range of digital marketing solutions including website design.' },
  ],
  videoBg: `${BASE}/2lm75cuteEDnVvXU8Vbl0AzfmO8R8c7t6v6bWzJI.jpg`,
  partners: [
    `${BASE}/O7z0pWucZkLSpmTkLIQS8ByXOsnEsooyBkGGSUJI.svg`,
    `${BASE}/36CrQcccrWVrZkb4O6hl82eaMEqytZ40UltoEFae.svg`,
    `${BASE}/epORN2a2OiLItCpPuP82mOj0orj7AzoKgtdHkPHy.svg`,
    `${BASE}/xjODbS4LV6BPt7AN2SmoZGHWeG2H27PVAlKZS7jw.svg`,
  ],
  destinations: [
